...
class EntityLevelEncoder(nn.Module):
    def __init__(self, transformer, max_objects, object_dim, feature2d_dim, hidden_dim, word_dim):
    ...
    def forward(self, features_2d: Tensor, objects: Tensor, objects_mask: Tensor):
        """
        ...
        bsz, sample_numb, max_objects_per_video = features_2d.shape[0], features_2d.shape[1], objects.shape[1]
        ...
        content_vectors = features_2d # (bsz, sample_numb, hidden_dim)
